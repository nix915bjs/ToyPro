...
<div id="header">
    	...
    	<div class="logoContainer">
        	<div><a href="../index/index.jsp"><img src="../images/logo_text.png" alt="" /></a></div>
        ...
        <div class="menu">
        	<ul>
                ...
                <li>
                	<span id="toySearch"><a href="../toysearch/search.jsp">장난감검색</a>
                	<ul class="localmenu">
            			<li>
            				<a href="../toysearch/search.jsp">장난감검색</a>
            			</li>
            			<p/>
            			<li>
            				<a href="">NEW 장난감목록</a>
